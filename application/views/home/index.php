        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Location based consumption</h3>
...
<script src="<?php echo base_url().'resources/'; ?>plugins/chartjs/Chart.min.js"></script>
  ...
  $(function () {
    ...
    <?php 
        ...
        foreach($allUserVsUnit as $single): 

          echo "{value:$single->garbage_unit,
                color:'#".substr(md5(rand()), 0, 6)."',
                highlight:'#".substr(md5(rand()), 0, 6)."',label:'$single->name'},";
        endforeach;
    ?>
    ];
    var pieOptions = {
    ...
    var barChartData =  {
      labels: [
        ...
        foreach($allLocationVsUnit as $value): 
      ...
      datasets: [
        {
          ...
          data: [
            ...
            <?php 
              ...
              foreach($allLocationVsUnit as $v): 
