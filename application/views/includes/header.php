...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>GARB</b>PROCESSOR</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Manish Lamichhane</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                 Manish Lamichhane - Web Developer
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'co2/'; ?>"><i class="fa fa-circle-o"></i>CO2</a></li>
            <li><a href="<?php echo base_url().'user/'; ?>"><i class="fa fa-circle-o"></i>User</a></li>
            <li><a href="<?php echo base_url().'recycle/'; ?>"><i class="fa fa-circle-o"></i>Recycle</a></li>
          </ul>
        </li>
      </ul>
    </section>
